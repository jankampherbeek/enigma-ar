...
func TestCalcAspectsNotEnoughPoints(t *testing.T) {
	baseOrb := 10.0
	...
	if err == nil {
		t.Errorf("CalcAspects should have returned an error for not enough points")
	}
	if len(result) > 0 {
		t.Errorf("CalcAspects should have returned an empty result for not enough points")
	}
}

func TestCalcAspectsNoAspects(t *testing.T) {
	baseOrb := 10.0
	...
	if err == nil {
		t.Errorf("CalcAspects should have returned an error for not enough aspects")
	}
	if len(result) > 0 {
		t.Errorf("CalcAspects should have returned an empty result for not enough aspects")
	}
}

func TestCalcAspectsNotEnoughConfigPoints(t *testing.T) {
	baseOrb := 10.0
	...
	if err == nil {
		t.Errorf("CalcAspects should have returned an error for not enough config points")
	}
	if len(result) > 0 {
		t.Errorf("CalcAspects should have returned an empty result for not enough config points")
	}
}

func TestCalcAspectsNoConfigAspects(t *testing.T) {
	baseOrb := 10.0
	...
	if err == nil {
		t.Errorf("CalcAspects should have returned an error for not enough configaspects")
	}
	if len(result) > 0 {
		t.Errorf("CalcAspects should have returned an empty result for not enough configaspects")
	}
}

func TestCalcAspectsMissingConfigPoint(t *testing.T) {
	baseOrb := 10.0
	...
	if err == nil {
		t.Errorf("CalcAspects should have returned an error for missing configpoints")
	}
	if len(result) > 0 {
		t.Errorf("CalcAspects should have returned an empty result for missing configpoints")
	}
}

func TestCalcAspectsMissingConfigAspect(t *testing.T) {
	baseOrb := 10.0
	...
	if err == nil {
		t.Errorf("CalcAspects should have returned an error for missing config aspects")
	}
	if len(result) > 0 {
		t.Errorf("CalcAspects should have returned an empty result for missing config aspects")
	}
}

func TestCalcAspectsPositionTooLarge(t *testing.T) {
	baseOrb := 10.0
	...
	if err == nil {
		t.Errorf("CalcAspects should have returned an error for a position that is too large")
	}
	if len(result) > 0 {
		t.Errorf("CalcAspects should have returned an empty result for a position that is too large")
	}
}

func TestCalcAspectsPositionTooSmall(t *testing.T) {
	baseOrb := 10.0
	...
	if err == nil {
		t.Errorf("CalcAspects should have returned an error for a position that is too small")
	}
	if len(result) > 0 {
		t.Errorf("CalcAspects should have returned an empty result for a position that is too small")
	}
}
